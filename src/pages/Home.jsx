...
export const Home = () => {
  ...
  return (
    <div className="flex flex-col gap-12 py-4 overflow-x-hidden text-slate-800 dark:text-slate-100 transition-colors duration-500">
      ...
      <section className="py-12 border-y border-slate-200 dark:border-white/5 grid grid-cols-2 md:grid-cols-4 gap-8 font-mono">
        <div className="flex flex-col items-center gap-1">
          <span className="text-3xl sm:text-4xl font-extrabold text-slate-850 dark:text-white font-display">
            <CountUp to="75" suffix="k+" />
          </span>
          <span className="text-[10px] text-slate-400 uppercase tracking-widest font-black">Happy Travelers</span>
        </div>
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <span className="text-[10px] text-slate-400 uppercase tracking-widest font-black">Destinations mapped</span>
        </div>
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <span className="text-[10px] text-slate-400 uppercase tracking-widest font-black">Satisfaction Rate</span>
        </div>

        <div className="flex flex-col items-center gap-1">
          <span className="text-3xl sm:text-4xl font-extrabold text-slate-850 dark:text-white font-display">
            <CountUp to="450" suffix="k" />
          </span>
          <span className="text-[10px] text-slate-400 uppercase tracking-widest font-black">Saved Itineraries</span>
        </div>
      </section>
      ...
      <section className="flex flex-col gap-6 text-center max-w-3xl mx-auto">
        ...
        <div className="relative min-h-[220px] sm:min-h-[180px] mt-4 p-6 sm:p-8 rounded-3xl bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-white/5 shadow-xl flex flex-col justify-between items-center text-center">
          ...
          <div className="mt-4 flex flex-col items-center gap-1">
            ...
            <span className="text-[9px] text-slate-455 font-bold uppercase tracking-wider font-mono">
