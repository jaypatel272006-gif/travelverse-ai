...
export const HomeDashboardSection = () => {
  const stats = [
    { label: 'COORDINATES VISITED', value: '14 / 28', percent: 50 },
    { label: 'TOTAL DAYS TRAVELED', value: '42 DAYS', percent: 80 },
    { label: 'CARBON OFFSET LOGS', value: '2.4 Tons', percent: 65 }
  ];

  return (
    <section className="py-20 relative overflow-hidden bg-slate-950 border-b border-white/10 px-4 sm:px-6 lg:px-8">
      {/* Light spotlight bg */}
      <div className="absolute top-1/2 left-1/3 w-[450px] h-[450px] bg-[radial-gradient(circle,rgba(45,212,191,0.03)_0%,transparent_75%)] pointer-events-none z-0" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-6">
            {stats.map((stat, idx) => (
              <motion.div
                ...
                className="rounded-3xl border border-white/10 bg-slate-900/60 p-6 flex flex-col justify-between text-left hover:border-teal-500/20 transition-all duration-300 relative shadow-md group"
              >
                <div className="flex flex-col gap-3">
                  <span className="text-[8px] font-mono text-slate-500 uppercase font-black">{stat.label}</span>
                ...
                <div className="mt-6 flex flex-col gap-2">
                  ...
                  <span className="text-[8.5px] font-mono text-teal-400 font-bold self-end">{stat.percent}% OF MATRIX ACHIEVED</span>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <div className="glass-card-neo p-6 rounded-3xl border border-white/10 flex flex-col justify-between text-left relative overflow-hidden group">
            ...
            <div className="flex flex-col gap-5 relative z-10">
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-3 p-2 bg-slate-900/80 rounded-2xl border border-white/5">
                  <div className="w-8 h-8 rounded-lg bg-teal-500/10 flex items-center justify-center text-teal-400">
                    <Award size={16} />
                  </div>
                  <div>
                    <span className="text-[9px] font-mono text-slate-400 block uppercase font-bold">Unesco Stamp</span>
                ...
                <div className="flex items-center gap-3 p-2 bg-slate-900/80 rounded-2xl border border-white/5">
                  ...
                  <div>
                    <span className="text-[9px] font-mono text-slate-400 block uppercase font-bold">Explorer Rank</span>
