        ...
        <div>
          ...
          <div className="flex flex-wrap gap-1 mb-5">
            {tags.map((tag) => (
              <span
                key={tag}
                className="px-2 py-0.5 text-[10px] font-medium rounded bg-teal-50 dark:bg-teal-950/35 text-teal-700 dark:text-teal-300 border border-teal-100/50 dark:border-teal-900/30"
              >
                {tag}
              </span>
            ))}
